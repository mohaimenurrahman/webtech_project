...
<body>
	...
	<form method="post" action="../controller/reviewcheck.php">
      ...
      <a href="../views/eventlist.php" class="next round">&#8250;</a>
      <a href="../views/reviewlist.php"><i class="fa fa-refresh" style="font-size:20px"></i></a>
      </div>
      ...
      <input type="text" id="name" name="name" value="" onkeyup="ajax()" />
	    ...
	    <script type="text/javascript" src="reviewscript.js"></script>
