...
<body>
	...
	<form method="post" action="../controller/companycheck.php">
      ...
      <a href="../views/companyprofile.php" class="next round">&#8250;</a>
      <a href="../views/userlist.php"><i class="fa fa-refresh" style="font-size:20px"></i></a>
      </div>
      ...
      <input type="text" id="name" name="name" value="" onkeyup="ajax()" />
	    ...
	    <script type="text/javascript" src="seekersscript.js"></script>
